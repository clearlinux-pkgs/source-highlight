...
#
# Source0 file verified with key 0x036A75309D33E5B5 (tom@tromey.com)
#
...
%package license
Summary: license components for the source-highlight package.
Group: Default

%description license
license components for the source-highlight package.


%package man
Summary: man components for the source-highlight package.
Group: Default

%description man
man components for the source-highlight package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684428998
...
cp %{_builddir}/source-highlight-%{version}/COPYING %{buildroot}/usr/share/package-licenses/source-highlight/af0a86c5fbc3c0fa0cbf93f8a8a0adf00ace50b3 || :
%make_install
...
/usr/share/source-highlight/c_preprocessor.lang
...
/usr/share/source-highlight/ipxe.lang
...
/usr/share/source-highlight/rust.lang
...
/usr/share/source-highlight/vim.lang
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/source-highlight/af0a86c5fbc3c0fa0cbf93f8a8a0adf00ace50b3

%files man
%defattr(0644,root,root,0755)
/usr/share/man/man1/check-regexp.1
/usr/share/man/man1/source-highlight-settings.1
/usr/share/man/man1/source-highlight.1
